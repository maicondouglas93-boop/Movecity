...
function normalizeCaptainLocation(location, now = Date.now()) {
    ...
    if (!Number.isFinite(timestamp) || timestamp > now + MAX_FUTURE_SKEW_MS || timestamp < now - MAX_LOCATION_AGE_MS) {
