        ...
        <div>
            ...
            <div className='flex flex-col items-center mb-5'>
                <div className='relative h-20 w-20 flex items-center justify-center'>
                    ...
                    <img className='h-16 w-16 absolute rounded-full object-contain bg-white p-1 shadow-md border border-green-200' src={vehicleImages[props.vehicleType] || vehicleImages.car} alt="" />
                </div>
                <p className='text-sm text-green-600 mt-3 animate-pulse'>Buscando motoristas próximos...</p>
            </div>
