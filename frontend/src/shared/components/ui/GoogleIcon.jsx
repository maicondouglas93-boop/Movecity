...
// Ícone oficial do Google embutido no bundle — antes vinha hotlinkado de svgrepo.com
// (item 5/§1.5 da auditoria de UX). Usado em UserLogin.jsx e UserSignup.jsx.
const GoogleIcon = ({ className = 'w-6 h-6' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 18 18" className={className} aria-hidden="true">
        ...
        <path fill="#34A853" d="M9 18c2.43 0 4.4673-.8064 5.9564-2.1805l-2.9086-2.2581c-.8064.54-1.8368.8591-3.0477.8591-2.3441 0-4.3282-1.5831-5.0359-3.7104H.9573v2.3318C2.4382 15.9832 5.4818 18 9 18z" />
