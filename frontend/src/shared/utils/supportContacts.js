...
export const supportEmailUrl = (message, subject = 'Motorista — finalização pendente') => `mailto:${SUPPORT_EMAIL}?subject=${encodeURIComponent(subject)}&body=${encodeURIComponent(message)}`
